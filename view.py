...
class V3:
    def __init__(self, tela):
        ...
        self.botoes_v3['atualiza'] = tk.Button(self.f21, text = 'atualiza', bg = 'red', fg = 'white')
        self.botoes_v3['atualiza'].pack(fill = tk.BOTH, side = tk.LEFT)
